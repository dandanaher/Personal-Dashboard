...
export function MobileCanvasView({ canvasId, onClose }: MobileCanvasViewProps) {
    ...
    return (
        <div className="fixed inset-0 z-[60] bg-secondary-50 dark:bg-black flex flex-col pt-safe-top pb-0">
            {/* Header */}
